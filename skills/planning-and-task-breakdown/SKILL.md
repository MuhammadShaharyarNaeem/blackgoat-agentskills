...
## Reference Documents
Before starting implementation, you MUST use the `view_file` tool to read the following documents to understand the full context and architectural constraints. Do not proceed until you have read them.
