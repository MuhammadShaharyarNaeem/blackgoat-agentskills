...
// Frozen fixture for the quick-lane eval: the pre-existing suite for the
// orders service, green and unrelated to this case's change.
//
// It is here so `node --test` is a real, non-trivial check rather than a
// one-case formality, and so tests/ has something to be frozen ABOUT. A rename
// of formatAmount touches nothing this file reads. grade.ps1 byte-compares it
// against the fixture: this file must come out of the run unchanged.
