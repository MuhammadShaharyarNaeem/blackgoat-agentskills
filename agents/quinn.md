...
| pipeline-tools | `{PLUGIN_ROOT}/pipeline-tools/SKILL.md` | When writing the test report — the Coverage Ledger grammar (status tokens, evidence rule) is owned by § check_coverage.py; the acceptance-results shape by § check_acceptance_suite.py |
