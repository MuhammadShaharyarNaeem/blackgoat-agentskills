...
- **Self-test** — **39** cases, each against a real temp git repo, including an end-to-end capture written by the real `run_quiet.py`. Depth (the two divergences, the frozen status-letter rule, the copy-not-import decision, the case inventory): `references/check_quick_close.md`.
