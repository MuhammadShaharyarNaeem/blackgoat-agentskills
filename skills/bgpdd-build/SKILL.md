...
- **Git Workflow**:
  ...
  - **The commit gate is mechanical: its preconditions are artifacts you read off disk, not a judgement you form.** Before writing the commit, open both files and confirm:
    a. `implementation/review-report.md` — the **latest** verdict recorded for this milestone is `Approve`, AND it postdates Mason's last diff for this milestone. A verdict written before the most recent fix reviewed different code and does not count.
