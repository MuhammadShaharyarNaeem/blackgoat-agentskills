...
- Write your comprehensive findings to the output path specified by the Orchestrator (e.g., `.docs/summary/{feature}/{api}.md` during Phase 0.5, or `.docs/{project-name}/research/` during Phase 2). Name the file after your assigned topic.
