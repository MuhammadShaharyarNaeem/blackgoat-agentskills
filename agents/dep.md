...
| shipping-and-launch | `{PLUGIN_ROOT}/shipping-and-launch/SKILL.md` | Always — fires on both of Dep's delegation sites (build Phase 5; shipping Stage 2) |
